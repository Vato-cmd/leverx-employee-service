...
const list = document.getElementById("permissions-container");
      ...
      <div class="permissions-user-layout" data-id="${user.id}">
        <div class="permissions-user-layout-inner">
            <div class="permissions-inner-flex">
              ...
              <img src="${user.user_avatar}" alt="${user.first_name}" class="permissions-avatar">
              <p>${user.first_name} ${user.last_name}</p>
            </div>
            <div class="permissions-inner-flex">
              <button data-role="Employee" class="${user.role === "Employee" ? "indicated" : ""}" ${user.role === "Admin" ? "disabled" : ""}>Employee</button>
              <button data-role="HR" class="${user.role === "HR" ? "indicated" : ""}" ${user.role === "Admin" ? "disabled" : ""}>HR</button>
            </div>
            <div class="permissions-inner-flex">
              <button class="${user.role !== "Admin" ? "indicated" : ""}">Employee</button>
              <button class="${user.role === "Admin" ? "indicated" : ""}">PO</button>
              <button>DD</button>

                
            </div>
            <div class="permissions-inner-flex admin-cell">
             <button class="${user.role === "Admin" ? "indicated" : ""}">Admin</button>
            </div>
...
async function newUserRoleFunc(id, newRole) {
    try {
